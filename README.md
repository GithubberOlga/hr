...
В ходе **знакомства с данными** был изучен датасет в целом: 607 записей без пропущенных значений и дубликатов. Типы данных, представленных в признаках датасета, соответствуют содержанию представленных в них информации. Таблица содержала 4 подлежащих удалению неинформативных признака: 'Unnamed: 0', 'salary', 'salary_currency', 'employee_residence'.
